...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // reset enemyHealth before starting new fight with random health with min health 40 and max health 60
...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt(
    'Would you like to REFILL your health, UPRADE your attack, or LEAVE the store? Please enter one: "REFILL", "UPGRADE", or "LEAVE" to make a choice.'
    );
